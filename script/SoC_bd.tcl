...
if { $bCheckIPs == 1 } {
   set list_check_ips "\ 
xilinx.com:hls:UltraNet_Bypass:1.2\
...
proc create_root_design { parentCell } {
  ...
  # Create instance: UltraNet_Bypass_0, and set properties
  set UltraNet_Bypass_0 [ create_bd_cell -type ip -vlnv xilinx.com:hls:UltraNet_Bypass:1.2 UltraNet_Bypass_0 ]
  ...
  connect_bd_intf_net -intf_net UltraNet_Bypass_0_out_r [get_bd_intf_pins UltraNet_Bypass_0/out_r] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins UltraNet_Bypass_0/in_r] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net ps8_0_axi_periph_M00_AXI [get_bd_intf_pins UltraNet_Bypass_0/s_axi_control] [get_bd_intf_pins ps8_0_axi_periph/M00_AXI]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0xA0000000 [get_bd_addr_spaces zynq_ultra_ps_e_0/Data] [get_bd_addr_segs UltraNet_Bypass_0/s_axi_control/Reg] SEG_UltraNet_Bypass_0_Reg
